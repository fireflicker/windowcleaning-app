...
.method public loadUrl(Ljava/lang/String;)V
    ...
    invoke-interface {p0, p1, v2}, Lorg/apache/cordova/CordovaWebView;->loadUrlIntoView(Ljava/lang/String;Z)V
...
.method protected makeWebView()Lorg/apache/cordova/CordovaWebView;
    ...
    invoke-direct {v0, p0}, Lorg/apache/cordova/CordovaWebViewImpl;-><init>(Lorg/apache/cordova/CordovaWebViewEngine;)V
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 374
    iget-object p0, p0, Lorg/apache/cordova/CordovaActivity;->cordovaInterface:Lorg/apache/cordova/CordovaInterfaceImpl;

    invoke-virtual {p0, p1, p2, p3}, Lorg/apache/cordova/CordovaInterfaceImpl;->onActivityResult(IILandroid/content/Intent;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 513
    invoke-virtual {p0, p1}, Lorg/apache/cordova/PluginManager;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onDestroy()V
    ...
    .line 326
    invoke-interface {p0}, Lorg/apache/cordova/CordovaWebView;->handleDestroy()V
...
.method protected onNewIntent(Landroid/content/Intent;)V
    ...
    .line 266
    invoke-interface {p0, p1}, Lorg/apache/cordova/CordovaWebView;->onNewIntent(Landroid/content/Intent;)V
...
.method protected onPause()V
    ...
    invoke-interface {p0, v0}, Lorg/apache/cordova/CordovaWebView;->handlePause(Z)V
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lorg/apache/cordova/CordovaInterfaceImpl;->onRequestPermissionResult(I[Ljava/lang/String;[I)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string p2, "JSONException: Parameters fed into the method are not valid"
...
.method protected onResume()V
    ...
    iget-boolean p0, p0, Lorg/apache/cordova/CordovaActivity;->keepRunning:Z

    invoke-interface {v0, p0}, Lorg/apache/cordova/CordovaWebView;->handleResume(Z)V
...
.method protected onStart()V
    ...
    .line 314
    :cond_0
    invoke-interface {p0}, Lorg/apache/cordova/CordovaWebView;->handleStart()V
...
.method protected onStop()V
    ...
    .line 300
    :cond_0
    invoke-interface {p0}, Lorg/apache/cordova/CordovaWebView;->handleStop()V
