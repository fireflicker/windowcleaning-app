...
.method public run()V
    ...
    invoke-virtual {v0, p0}, Landroidx/appcompat/app/AppCompatActivity;->runOnUiThread(Ljava/lang/Runnable;)V

    goto :goto_1

    .line 185
    :cond_0
    iget-object p0, p0, Lorg/apache/cordova/CordovaWebViewImpl$2;->this$0:Lorg/apache/cordova/CordovaWebViewImpl;

    invoke-static {p0}, Lorg/apache/cordova/CordovaWebViewImpl;->-$$Nest$fgetcordova(Lorg/apache/cordova/CordovaWebViewImpl;)Lorg/apache/cordova/CordovaInterface;
    ...
    const-string v0, "Cordova activity does not exist."
