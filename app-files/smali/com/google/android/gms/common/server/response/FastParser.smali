...
.method private final zai(Ljava/io/BufferedReader;Lcom/google/android/gms/common/server/response/FastJsonResponse;)Z
    ...
    :cond_0
    iget-object v9, v0, Lcom/google/android/gms/common/server/response/FastParser;->zal:Ljava/util/Stack;
    ...
    .line 37
    invoke-direct {v0, v1, v9}, Lcom/google/android/gms/common/server/response/FastParser;->zay(Ljava/io/BufferedReader;[C)V
    ...
    :cond_1
    iget-object v11, v0, Lcom/google/android/gms/common/server/response/FastParser;->zal:Ljava/util/Stack;
    ...
    :cond_4
    iget-object v14, v0, Lcom/google/android/gms/common/server/response/FastParser;->zal:Ljava/util/Stack;
    ...
    .line 47
    invoke-direct {v0, v1, v9}, Lcom/google/android/gms/common/server/response/FastParser;->zai(Ljava/io/BufferedReader;Lcom/google/android/gms/common/server/response/FastJsonResponse;)Z
    ...
    .line 33
    :cond_7
    invoke-direct {v0, v7}, Lcom/google/android/gms/common/server/response/FastParser;->zaz(I)V

    goto :goto_5

    .line 26
    :cond_8
    iget-object v11, v0, Lcom/google/android/gms/common/server/response/FastParser;->zab:[C

    iget-object v10, v0, Lcom/google/android/gms/common/server/response/FastParser;->zad:Ljava/lang/StringBuilder;
    ...
    :cond_c
    iget-object v6, v0, Lcom/google/android/gms/common/server/response/FastParser;->zab:[C

    iget-object v11, v0, Lcom/google/android/gms/common/server/response/FastParser;->zad:Ljava/lang/StringBuilder;
    ...
    .line 21
    :pswitch_2
    iget-object v6, v0, Lcom/google/android/gms/common/server/response/FastParser;->zac:[C

    iget-object v9, v0, Lcom/google/android/gms/common/server/response/FastParser;->zae:Ljava/lang/StringBuilder;

    sget-object v10, Lcom/google/android/gms/common/server/response/FastParser;->zak:[C

    .line 49
    invoke-direct {v0, v1, v6, v9, v10}, Lcom/google/android/gms/common/server/response/FastParser;->zan(Ljava/io/BufferedReader;[CLjava/lang/StringBuilder;[C)Ljava/lang/String;
    ...
    .line 20
    invoke-direct {v0, v1, v6}, Lcom/google/android/gms/common/server/response/FastParser;->zam(Ljava/io/BufferedReader;Lcom/google/android/gms/common/server/response/zai;)Ljava/util/ArrayList;
    ...
    .line 19
    invoke-direct {v0, v1, v6}, Lcom/google/android/gms/common/server/response/FastParser;->zar(Ljava/io/BufferedReader;Z)Z

    move-result v9

    invoke-virtual {v2, v5, v9}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zam(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Z)V
    ...
    invoke-virtual {v2, v5, v9, v10}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zai(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;D)V
    ...
    invoke-virtual {v2, v5, v9, v10}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zae(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;J)V
    ...
    .line 55
    :goto_7
    invoke-direct {v0, v5}, Lcom/google/android/gms/common/server/response/FastParser;->zaz(I)V
...
.method private final zao(Ljava/io/BufferedReader;)I
    ...
    :cond_0
    iget-object p0, p0, Lcom/google/android/gms/common/server/response/FastParser;->zac:[C
...
.method private final zaw(Ljava/io/BufferedReader;)C
    ...
    :cond_1
    iget-object p0, p0, Lcom/google/android/gms/common/server/response/FastParser;->zaa:[C
...
.method private final zaz(I)V
    ...
    .line 2
    iget-object p0, p0, Lcom/google/android/gms/common/server/response/FastParser;->zal:Ljava/util/Stack;
