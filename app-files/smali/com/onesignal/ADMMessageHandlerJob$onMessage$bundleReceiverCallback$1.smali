...
.method public onBundleProcessed(Lcom/onesignal/NotificationBundleProcessor$ProcessedBundleResult;)V
    ...
    iget-object p0, p0, Lcom/onesignal/ADMMessageHandlerJob$onMessage$bundleReceiverCallback$1;->$context:Landroid/content/Context;

    .line 25
    invoke-virtual {v1, p1}, Lcom/onesignal/OSNotificationGenerationJob;->setJsonPayload(Lorg/json/JSONObject;)V

    .line 26
    invoke-virtual {v1, p0}, Lcom/onesignal/OSNotificationGenerationJob;->setContext(Landroid/content/Context;)V
    ...
    .line 30
    invoke-static {v1, p0}, Lcom/onesignal/NotificationBundleProcessor;->processJobForDisplay(Lcom/onesignal/OSNotificationGenerationJob;Z)I
